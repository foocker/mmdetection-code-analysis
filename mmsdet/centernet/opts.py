...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('config', help='train config file path')
    self.parser.add_argument('--dataset', default='cig_box',
                             help='coco | kitti | coco_hp | pascal | cig_box')
    ...
    self.parser.add_argument('--vis_thresh', type=float, default=0.35,
    ...
    self.parser.add_argument('--not_reg_bbox', action='store_true',  
                             help='not regression bounding box size.')    # in parser, may remove
